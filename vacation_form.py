...
def create_vacation_form(filename, context):
    ...
    title = 'VISHNU INSTITUTE OF TECHNOLOGY, ANDHRA PRADESH'
    can.drawCentredString(330, 740, title)
    place = 'BHIMAVARAM - 534202, WEST GODAVARI DIST., ANDHRA PRADESH, INDIA'
    can.setFontSize(10)
