    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('designation', models.CharField(choices=[('Caretaker', 'Caretaker'), ('Warden', 'Warden'), ('Deputy Chief-Warden Boys', 'Deputy Chief-Warden Boys'), ('Deputy Chief-Warden Girls', 'Deputy Chief-Warden Girls'), ('Chief-Warden', 'Chief-Warden'), ('Hostel Office', 'Hostel Office')], max_length=25)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('account_email', models.EmailField(blank=True, max_length=254, null=True, unique=True)),
                ('regd_no', models.CharField(max_length=8, unique=True, validators=[django.core.validators.MinLengthValidator(6)])),
                ('roll_no', models.CharField(blank=True, max_length=8, null=True, unique=True, validators=[django.core.validators.MinLengthValidator(6)])),
                ('name', models.CharField(max_length=100)),
                ('email', models.EmailField(blank=True, max_length=254, null=True)),
                ('year', models.IntegerField(choices=[(1, 1), (2, 2), (3, 3), (4, 4)])),
                ('branch', models.CharField(blank=True, max_length=40, null=True)),
                ('gender', models.CharField(choices=[('Male', 'Male'), ('Female', 'Female')], max_length=7)),
                ('pwd', models.BooleanField(blank=True, default=False)),
                ('community', models.CharField(blank=True, max_length=25, null=True)),
                ('aadhar_number', models.CharField(blank=True, default='0000', max_length=12, null=True, validators=[django.core.validators.MinLengthValidator(4)])),
                ('dob', models.DateField(blank=True, default='2000-01-01', null=True, validators=[institute.validators.date_no_future])),
                ...
                ('phone', models.CharField(max_length=10, validators=[institute.validators.numeric_only])),
                ('parents_phone', models.CharField(blank=True, max_length=10, null=True, validators=[institute.validators.numeric_only])),
